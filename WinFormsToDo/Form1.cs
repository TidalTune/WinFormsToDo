namespace WinFormsToDo
{
    public partial class Form1 : Form
    {
        ...
        private void submitForm(object sender, EventArgs e)
        {
            ...
            //exit
            if (Validators.IsEmptyText(txtTaskDescription)) // description must exist, due date must be formatted as valid date
            {
        ...
        //    var selectedItem = (string)lbTaskList.SelectedItem;
        ...
        //    // STRING FORMAT: # - Task Description
